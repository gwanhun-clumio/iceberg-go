...
[![Go Reference](https://pkg.go.dev/badge/github.com/gwanhun-clumio/iceberg-go.svg)](https://pkg.go.dev/github.com/gwanhun-clumio/iceberg-go)
...
```shell
$ git clone https://github.com/gwanhun-clumio/iceberg-go.git
...
### CLI Usage
Run `go build ./cmd/iceberg` from the root of this repository to build the CLI executable, alternately you can run `go install github.com/gwanhun-clumio/iceberg-go/cmd/iceberg` to install it to the `bin` directory of your `GOPATH`.
